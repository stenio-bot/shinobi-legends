...
function Keybind.init()
  ...
  if #Keybind.presets == 0 then
    -- Shinobi Legends: os presets sao as vilas, nao as vocations de Tibia.
    -- Sao apenas rotulos: viram nomes de arquivo em /controls/keybinds/<nome>.otml
    -- e /controls/hotkeys/<nome>.otml, e o texto do combobox em client_options.
    -- Mantidos em ASCII de proposito (Nevoa, sem acento) porque o nome vai direto
    -- para o sistema de arquivos; o acento em cp1252 gera um nome invalido em UTF-8.
    Keybind.presets = { "Folha", "Nevoa", "Nuvem", "Areia" }
    Keybind.currentPreset = "Folha"
  else

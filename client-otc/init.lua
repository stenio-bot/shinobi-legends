...
Services = {
    ...
    clientAssets = {
        enabled = false, -- Shinobi Legends: não baixar assets 13.x da Tibia; usamos data/things/1098 próprios
...
g_app.setName("Shinobi Legends");
g_app.setCompactName("shinobi");
g_app.setOrganizationName("shinobi-legends");

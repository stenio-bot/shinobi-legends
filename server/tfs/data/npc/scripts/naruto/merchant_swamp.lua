...
shopModule:addBuyableItem({'pílula de chakra média'}, 7589, 120, 1, 'pílula de chakra média')
...
shopModule:addBuyableItem({'botas do pântano'}, 2195, 1500, 1, 'botas do pântano')
...
shopModule:addBuyableItem({'fūma shuriken'}, 7368, 6000, 1, 'fūma shuriken')

...
if NarutoQuests then
	for _, q in ipairs(NarutoQuests.list) do
		if q.kind == 'talk_to' and q.targetNpc == 'merchant_swamp' then
...
shopModule:addBuyableItem({'p\xEDlula de chakra m\xE9dia'}, 7589, 120, 1, 'p\xEDlula de chakra m\xE9dia')
shopModule:addBuyableItem({'ant\xEDdoto'}, 8473, 40, 1, 'ant\xEDdoto')
shopModule:addBuyableItem({'colete de pele de sapo'}, 2463, 2200, 1, 'colete de pele de sapo')
shopModule:addBuyableItem({'botas do p\xE2ntano'}, 2195, 1500, 1, 'botas do p\xE2ntano')
shopModule:addBuyableItem({'wakizashi temperado'}, 2384, 1800, 1, 'wakizashi temperado')
shopModule:addBuyableItem({'katana do ronin'}, 2412, 2500, 1, 'katana do ronin')
shopModule:addBuyableItem({'espad\xE3o de a\xE7o'}, 2413, 5000, 1, 'espad\xE3o de a\xE7o')
shopModule:addBuyableItem({'f\x3Fma shuriken'}, 7368, 6000, 1, 'f\x3Fma shuriken')

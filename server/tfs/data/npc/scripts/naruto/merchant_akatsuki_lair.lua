...
shopModule:addSellableItem({'cal\xE7a da aurora carmesim'}, 23539, 15552, 'cal\xE7a da aurora carmesim')
...
shopModule:addSellableItem({'chap\xE9u de kage'}, 2498, 12800, 'chap\xE9u de kage')
shopModule:addSellableItem({'manto de kage'}, 2472, 32000, 'manto de kage')
shopModule:addSellableItem({'cal\xE7a de kage'}, 10300, 19200, 'cal\xE7a de kage')
shopModule:addSellableItem({'sand\xE1lias de kage'}, 11117, 9600, 'sand\xE1lias de kage')
shopModule:addSellableItem({'l\xE2mina do kage'}, 6528, 33600, 'l\xE2mina do kage')
shopModule:addSellableItem({'leque de l\xE2minas do kage'}, 8851, 33600, 'leque de l\xE2minas do kage')

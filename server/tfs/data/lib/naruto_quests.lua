...
NarutoQuests.list = {
	...
	{id = 'q_wolves_1', npc = 'quest_giver_leaf', npcName = 'Capitã Rin', name = 'Lobos na trilha', text = 'Os lobos estão atacando viajantes. Mate 5.', kind = 'kill', monster = 'Lobo', count = 5, storage = 50013, reward = {xp = 120, ryo = 60, items = {{id = 7618, count = 1}}}},
	...
	{id = 'q_white_serpent', npc = 'quest_giver_swamp', npcName = 'Rastreador Goro', name = 'A Serpente Branca', text = 'Um renegado de pele pálida montou covil no fim da Floresta da Morte. Ele não é humano faz tempo. Mate a Serpente Branca.', kind = 'kill', monster = 'Serpente Branca', count = 1, storage = 50025, reward = {xp = 9000, ryo = 3500, items = {{id = 1956, count = 1}}}},
	...
	{id = 'exam_chunin_2a_pergaminho_ceu', npc = 'exam_proctor_forest', npcName = 'Instrutora Ibuki', name = 'Exame Chunin — Pergaminho do Céu', text = 'Etapa 2: sobrevivência na Floresta da Morte. O Sapo Ancião guarda um Pergaminho do Céu. Traga-o.', kind = 'kill', monster = 'Sapo Ancião', count = 1, storage = 50027, reward = {xp = 0, ryo = 0, items = {{id = 6287, count = 1}}}},
	{id = 'exam_chunin_2b_pergaminho_terra', npc = 'exam_proctor_forest', npcName = 'Instrutora Ibuki', name = 'Exame Chunin — Pergaminho da Terra', text = 'Agora o Pergaminho da Terra. A Serpente Branca guarda o dela no fim da floresta — só entre se estiver pronto.', kind = 'kill', monster = 'Serpente Branca', count = 1, storage = 50028, reward = {xp = 0, ryo = 0, items = {{id = 6288, count = 1}}}},
	{id = 'exam_chunin_3a_rival_pedra', npc = 'exam_proctor_forest', npcName = 'Instrutora Ibuki', name = 'Exame Chunin — Torneio (1/3)', text = 'Etapa 3: o torneio. Seu primeiro oponente veio da Vila da Pedra.', kind = 'kill', monster = 'Rival do Exame — Pedra', count = 1, storage = 50029, reward = {xp = 300, ryo = 50, items = {}}},
	...
	{id = 'q_ruins_shamans', npc = 'quest_giver_ruins', npcName = 'Ancião Kaito', name = 'Selos que não se apagam', text = 'Os xamãs mantêm a maldição viva. Silencie 8.', kind = 'kill', monster = 'Xamã da Maldição', count = 8, storage = 50043, reward = {xp = 14000, ryo = 4000, items = {{id = 2131, count = 1}}}},
	...
	{id = 'q_ruins_boss', npc = 'quest_giver_ruins', npcName = 'Ancião Kaito', name = 'Quem puxa os fios', text = 'No salão central alguém comanda tudo isso. Acabe com o Marionetista.', kind = 'kill', monster = 'Marionetista das Ruínas', count = 1, storage = 50045, reward = {xp = 30000, ryo = 12000, items = {{id = 2164, count = 1}}}, grantsRankProgress = 'jonin'},
}
NarutoQuests.byNpc = {}

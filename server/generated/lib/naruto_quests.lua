...
NarutoQuests.list = {
	...
	{id = 'q_elder_toad', npc = 'quest_giver_swamp', name = 'O Ancião', text = 'Derrote o Sapo Ancião no coração do pântano.', monster = 'Sapo Ancião', count = 1, storage = 50007, reward = {xp = 8000, ryo = 3000, items = {{id = 7589, count = 1}}}},

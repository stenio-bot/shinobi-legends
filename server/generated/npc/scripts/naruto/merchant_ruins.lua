...
shopModule:addBuyableItem({'kodachi das ruínas'}, 2383, 6200, 1, 'kodachi das ruínas')
shopModule:addBuyableItem({'kunai com corrente'}, 2410, 7200, 1, 'kunai com corrente')
shopModule:addBuyableItem({'máscara do clã perdido'}, 2457, 2900, 1, 'máscara do clã perdido')
shopModule:addBuyableItem({'manto do clã perdido'}, 2465, 7200, 1, 'manto do clã perdido')
shopModule:addBuyableItem({'grevas do clã perdido'}, 2478, 4300, 1, 'grevas do clã perdido')
shopModule:addBuyableItem({'botas do clã perdido'}, 2645, 2200, 1, 'botas do clã perdido')
...
shopModule:addBuyableItem({'pergaminho: prisão de água'}, 1967, 8000, 1, 'pergaminho: prisão de água')

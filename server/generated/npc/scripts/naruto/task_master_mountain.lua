...
if NarutoQuests then
	for _, q in ipairs(NarutoQuests.list) do
		if q.kind == 'talk_to' and q.targetNpc == 'task_master_mountain' then
...
local TASKS = NarutoTasks.byNpc['task_master_mountain'] or {}
...
npcHandler:setMessage(MESSAGE_GREET, "Ol\xE1, |PLAYERNAME|. Diga {tarefas} (lista), {tarefa} (aceitar) ou {entregar}.")
